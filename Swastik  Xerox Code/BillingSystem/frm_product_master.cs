...
namespace BillingSystem
{
    public partial class frm_Product_master : Form
    {
        ...
        public void BindGrid()
        {
            ...
            query = "SELECT ProductID, ProductName, ProductDescription FROM Product";
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    string query = string.Empty;
                    query = "delete Product where ProductID = " + lbl_id.Text.Trim();
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            if (btn_save.Text == "Save")
                query = "insert into Product (ProductName, ProductDescription) values ('" + txt_name.Text.Trim() + "','" + txt_ProductDescription.Text.Trim() + "')";
            else
                query = "update Product set ProductName = '" + txt_name.Text.Trim() + "', ProductDescription = '" + txt_ProductDescription.Text.Trim() + "' where ProductID = " + lbl_id.Text.Trim();
            string message = _datalayer.Opration(query);
            if (message == "Success")
            {
