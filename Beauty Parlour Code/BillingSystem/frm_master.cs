...
namespace BillingSystem
{
    public partial class frm_master : Form
    {
        ...
        private void frm_job_work_Load(object sender, EventArgs e)
        {
            ...
            DataTable _dtInvoiceNumber = _datalayer.bindDataTable("SELECT fld_value FROM tbl_default WHERE (fld_default_name = 'InvoiceNumber')");
            ...
            DataTable _dtBackUpDuration = _datalayer.bindDataTable("SELECT fld_value FROM tbl_default WHERE (fld_default_name = 'BackUpDuration')");
        ...
        private void btn_invoice_Click(object sender, EventArgs e)
        {
            ...
            string query = "update tbl_default set fld_value = '" + txt_invoice.Text.Trim().ToString() + "' where (fld_default_name = 'InvoiceNumber')";
        ...
        private void btn_password_Click(object sender, EventArgs e)
        {
            ...
            string query = "update tbl_default set fld_value = '" + txt_password.Text.Trim().ToString() + "' where (fld_default_name = 'RightsPassword')";
            string message = _datalayer.Opration(query);
            if (message == "Success")
            {
        ...
        private void btn_backup_Click(object sender, EventArgs e)
        {
            ...
            string message = _datalayer.Opration("update tbl_default set fld_value = '" + ckb_backup.Checked.ToString() + "' where (fld_default_name = 'BackUp')");
            message = _datalayer.Opration("update tbl_default set fld_value = '" + txt_bu_main.Text.Trim().ToString() + "' where (fld_default_name = 'FolderMain')");
            message = _datalayer.Opration("update tbl_default set fld_value = '" + txt_bu_sub.Text.Trim().ToString() + "' where (fld_default_name = 'FolderSub')");
            message = _datalayer.Opration("update tbl_default set fld_value = '" + cmb_bu_dur.Text.Trim().ToString() + "' where (fld_default_name = 'BackUpDuration')");
            message = _datalayer.Opration("update tbl_default set fld_value = '" + minutes.ToString() + "' where (fld_default_name = 'BackUpTime')");
            if (message == "Success")
            {
                MessageBox.Show("Bales fld_rate Update Successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show("Sorry!!! there are some issue to insert this record, please try again.", "Failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        //private void btn_p_dlt_Click(object sender, EventArgs e)
        //{
        ...
        //        query = "delete tbl_product where fld_product_id = " + lbl_p_id.Text.Trim();
        ...
        //            txt_product.Text = lbl_p_id.Text = "";
        //            btn_p_dlt.Visible = false;
        //            Reset();
        //        }
        //        else
        //        {
