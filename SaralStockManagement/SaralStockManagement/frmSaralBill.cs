...
{
    public partial class frmSaralBill : Form
    {
        public frmSaralBill()
        {
            InitializeComponent();
        ...
        private void frmSaralBill_Load(object sender, EventArgs e)
        {
        ...
        private void txt_billdate_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
            {
                e.SuppressKeyPress = true;
        ...
        private void txt_sale_price_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
            {
                e.SuppressKeyPress = true;
