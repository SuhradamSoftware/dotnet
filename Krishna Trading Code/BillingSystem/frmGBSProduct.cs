    ...
    public partial class frmGBSProduct : Form
    {
        ...
        public void DeleteRecord()
        {
            try
            {
                ...
                {
                    string query = string.Empty;
                    query = "update Product set IsDeleted = 1 where ProductID = " + lbl_id.Text.Trim();
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            if (btn_save.Text == "SAVE")
                query = "INSERT INTO Product (ProductName, ProductDescription, ProductCompany, Price) values ('" + txt_name.Text.Trim() + "','" + txt_ProductDescription.Text.Trim() + "','" + txt_company.Text.Trim() + "'," + txt_price.Text.Trim() + ")";
            else
                query = "UPDATE Product SET ProductName = '" + txt_name.Text.Trim() + "', ProductDescription = '" + txt_ProductDescription.Text.Trim() + "', ProductCompany = '" + txt_company.Text.Trim() + "', Price = " + txt_price.Text.Trim() + " where ProductID = " + lbl_id.Text.Trim();
            string message = _datalayer.Opration(query);
