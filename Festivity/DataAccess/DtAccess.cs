...
namespace DataAccess
{
    ...
    public class DtAccess
    {
        ...
        public int ExecuteNonQuery(string storedProcedure, SqlParameter[] param)
        {
            try
            {
                return SqlDBHelper.ExecuteNonQuery(DBConnection(), CommandType.StoredProcedure, storedProcedure, param);
            }
        ...
        public int ExecuteNonQuerywithTrans(string storedProcedure, SqlParameter[] param)
        {
            ...
            using (sqlTrans = conTrans.BeginTransaction())
            {
                try
                {
                    returnResult = SqlDBHelper.ExecuteNonQuery(sqlTrans, CommandType.StoredProcedure, storedProcedure, param);
                    sqlTrans.Commit();
                    return returnResult;
                }
                catch (Exception sq)
        ...
        public int ExecuteNonQuery(string storedProcedure)
        {
            try
            {
                return SqlDBHelper.ExecuteNonQuery(DBConnection(), CommandType.StoredProcedure, storedProcedure);
            }
            catch (SqlException sq)
            {
                throw sq;
        ...
        public int ExecuteNonQuerySQL(string sqlquery)
        {
            try
            {
                return SqlDBHelper.ExecuteNonQuery(DBConnection(), CommandType.Text, sqlquery);
            }
            catch (SqlException sq)
            {
                throw sq;
        ...
        public int ExecuteNonQuerywithTrans(string storedProcedure)
        {
            ...
            using (sqlTrans = conTrans.BeginTransaction())
            {
                try
                {
                    returnResult = SqlDBHelper.ExecuteNonQuery(sqlTrans, CommandType.StoredProcedure, storedProcedure);
                    sqlTrans.Commit();
                    return returnResult;
                }
                catch (Exception sq)
        ...
        public int ExecuteNonQuerywithTransfromFrontEnd(SqlTransaction sqlTrans, string storedProcedure, SqlParameter[] param)
        {
            try
            {
                int returnResult = SqlDBHelper.ExecuteNonQuery(sqlTrans, CommandType.StoredProcedure, storedProcedure, param);
                return returnResult;
            }
            catch (SqlException sq)
            {
        ...
        public DataSet ExecuteDataset(string storedProcedure, SqlParameter[] param)
        {
            try
            {
                return SqlDBHelper.ExecuteDataset(DBConnection(), CommandType.StoredProcedure, storedProcedure, param);
            }
            catch (SqlException sq)
            {
                throw sq;
        ...
        public DataSet ExecuteDatasetSQL(string storedProcedure)
        {
            try
            {
                return SqlDBHelper.ExecuteDataset(DBConnection(), CommandType.Text, storedProcedure);
            }
            catch (SqlException sq)
            {
                throw sq;
        ...
        public DataSet ExecuteDataset(string storedProcedure)
        {
            try
            {
                return SqlDBHelper.ExecuteDataset(DBConnection(), CommandType.StoredProcedure, storedProcedure);
            }
            catch (SqlException sq)
            {
                throw sq;
        ...
        public object ExecuteScalar(string storedProcedure, SqlParameter[] param)
        {
            try
            {
                return SqlDBHelper.ExecuteScalar(DBConnection(), CommandType.StoredProcedure, storedProcedure, param);
            }
            catch (SqlException sq)
            {
                throw sq;
        ...
        public object ExecuteScalar(SqlTransaction sqlTrans, string storedProcedure, SqlParameter[] param)
        {
            try
            {
                return SqlDBHelper.ExecuteScalar(sqlTrans, CommandType.StoredProcedure, storedProcedure, param);
            }
            catch (SqlException sq)
            {
                throw sq;
        ...
        public SqlDataReader ExecuteReader(string storedProcedure, SqlParameter[] param)
        {
            ...
            try
            {
                reader = SqlDBHelper.ExecuteReader(DBConnection(), CommandType.StoredProcedure, storedProcedure, param);
                return reader;
            }
            catch (SqlException sq)
            {
        ...
        public SqlDataReader ExecuteReader(string storedProcedure)
        {
            ...
            try
            {
                reader = SqlDBHelper.ExecuteReader(DBConnection(), CommandType.StoredProcedure, storedProcedure);
                return reader;
            }
            catch (SqlException sq)
            {
        ...
        public SqlDataReader ExecuteReaderSQL(string sqlquery)
        {
            ...
            try
            {
                reader = SqlDBHelper.ExecuteReader(DBConnection(), CommandType.Text, sqlquery);
                return reader;
            }
            catch (SqlException sq)
            {
